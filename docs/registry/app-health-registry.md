...
| Swagger 2.0 conversion | a 2.0 construct reaches the model and renders empty (§5.1.1: converter bug by definition) | `src/openapi/swagger2.js` | `swagger2.test.js` + 35 KB snapshot (largest in repo), `conversion-approximation` rule; e2e: `swagger2.spec.js` | green |
